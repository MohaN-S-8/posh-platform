...
const reports = [
  ...
  {
    title: "PDF Export Pack",
    endpoint: null,
    fileName: "",
    description: "PDF export requires a dedicated report rendering template.",
    status: "Planned",
  },
  {
    title: "CSV Export Pack",
    endpoint: null,
    fileName: "",
    description: "CSV export can be added from the same report datasets.",
    status: "Planned",
  },
];
