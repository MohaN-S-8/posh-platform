...
class CompanyMaster(Base):
    ...
    posh_policy = Column(String(200))
    posh_policy_version = Column(String(50))
    posh_policy_effective_date = Column(String(50))
    posh_policy_document_path = Column(String(500))
    posh_policy_document_name = Column(String(255))
    certificate_issue_mode = Column(String(20), default="Automatic")
