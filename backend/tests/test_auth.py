...
def test_signup_empty_first_name():
    response = client.post("/api/v1/auth/signup", json={
        "first_name": "", "last_name": "Kumar",
        "email": "test@example.com", "password": "Test@1234",
        "confirm_password": "Test@1234", "mobile": "9876543210",
    })
...
def test_signup_numbers_in_first_name():
    response = client.post("/api/v1/auth/signup", json={
        "first_name": "Ravi123", "last_name": "Kumar",
        "email": "test@example.com", "password": "Test@1234",
        "confirm_password": "Test@1234", "mobile": "9876543210",
    })
    assert response.status_code == 422
...
def test_signup_password_too_short():
    response = client.post("/api/v1/auth/signup", json={
        "first_name": "Ravi", "last_name": "Kumar",
        "email": "ravi@test.com", "password": "Ab@1",
        "confirm_password": "Ab@1", "mobile": "9876543210",
    })
    assert response.status_code == 422
...
def test_signup_password_no_special_char():
    response = client.post("/api/v1/auth/signup", json={
        "first_name": "Ravi", "last_name": "Kumar",
        "email": "ravi@test.com", "password": "Test12345",
        "confirm_password": "Test12345", "mobile": "9876543210",
    })
    assert response.status_code == 422
...
def test_signup_passwords_do_not_match():
    response = client.post("/api/v1/auth/signup", json={
        "first_name": "Ravi", "last_name": "Kumar",
        "email": "ravi@test.com", "password": "Test@1234",
        "confirm_password": "Test@5678", "mobile": "9876543210",
    })
    assert response.status_code == 422
...
def test_signup_invalid_mobile():
    response = client.post("/api/v1/auth/signup", json={
        "first_name": "Ravi", "last_name": "Kumar",
        "email": "ravi@test.com", "password": "Test@1234",
        "confirm_password": "Test@1234", "mobile": "123",
    })
    assert response.status_code == 422
